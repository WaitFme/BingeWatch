...
import com.anpe.bingewatch.core.data.mapper.WatchMapper.Companion.toDto
import com.anpe.bingewatch.core.data.mapper.WatchMapper.Companion.toEntity
import com.anpe.bingewatch.core.repository.DaoRepository
import com.anpe.bingewatch.core.repository.NetRepository
import com.anpe.bingewatch.ui.feature.home.HomeState
    ...
    private fun syncData() {
        viewModelScope.launch {
            ...
            try {
                ...
                _viewEvent.emit(HomeEvent.ShowToast("同步失败"))
            }
        }
    }
